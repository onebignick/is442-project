...
public class CustomerService {
    ...
    public List<Customer> getHighValueCustomers() {
        List<Customer> customerLifetimeSpendingList = customerRepository.findCustomerLifetimeSpending();
        customerLifetimeSpendingList.sort((a, b) -> ((Double) a.getLifetimeSpending()).compareTo((Double) b.getLifetimeSpending())); // compare based on 3rd element - lifetimespending
    ...
    public List<Customer> getMidTierCustomers() {
        List<Customer> customerLifetimeSpendingList = customerRepository.findCustomerLifetimeSpending();
        customerLifetimeSpendingList.sort((a, b) -> ((Double) a.getLifetimeSpending()).compareTo((Double) b.getLifetimeSpending()));
